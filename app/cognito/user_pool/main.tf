...
resource "aws_cognito_user_pool" "my90_user_pool" {
  name = "My90 User Pool"
  schema {
    name = "orgIds"
...
resource "aws_cognito_user_pool_client" "my90_user_pool_client" {
  name                                 = "My90 App Client"
  user_pool_id                         = "${aws_cognito_user_pool.my90_user_pool.id}"
  ...
  allowed_oauth_scopes                 = [
    ...
    "${aws_cognito_resource_server.my90_user_pool_resource_server.scope_identifiers}",
  ]
  callback_urls                        = [
    "https://staging.textmy90.com",
    "https://secure.textmy90.com",
    "http://localhost:6075"]
...
resource "aws_cognito_user_pool_domain" "my90_user_pool_domain" {
  domain       = "my90-${local.aws_account_id}"
  user_pool_id = "${aws_cognito_user_pool.my90_user_pool.id}"
}

resource "aws_cognito_resource_server" "my90_user_pool_resource_server" {
  identifier = "https://api.my90.com"
  name       = "My 90 API"
